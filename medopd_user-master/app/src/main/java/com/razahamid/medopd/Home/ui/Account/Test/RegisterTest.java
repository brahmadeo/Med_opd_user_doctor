...
import com.razahamid.medopd.Address.MapsActivity;
...
public class RegisterTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.LocationOnMap).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(RegisterTest.this, Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(RegisterTest.this,
                                new String[]{Manifest.permission.ACCESS_COARSE_LOCATION},
                              101);
                }
                startActivityForResult(new Intent(RegisterTest.this, MapsActivity.class),SelectLocation);
            }
        });
