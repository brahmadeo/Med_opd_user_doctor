package com.razahamid.medopd.Intro;
...
public class IntroImageWizard extends AppCompatActivity {
    ...
    private String about_title_array[] = {
            ...
            "We've got you covered with our trusted network of MCI registered doctors"
    };
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(IntroImageWizard.this, LoginPinActivity.class));
        finish();
    }
}