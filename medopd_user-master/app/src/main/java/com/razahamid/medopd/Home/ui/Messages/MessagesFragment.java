...
import com.razahamid.medopd.Adopters.AllMessagesList;
import com.razahamid.medopd.ExtraFiles.FirebaseRef;
import com.razahamid.medopd.Models.AllMessages;
import com.razahamid.medopd.R;
import com.razahamid.medopd.utils.Tools;
import com.razahamid.medopd.widget.LineItemDecoration;
...
private Calendar calendar;
    ...
    private void UpdateValue() {
        FirebaseDatabase.getInstance().getReference(ref.LastMessage+"/"+firebaseUser.getUid()).limitToLast(30).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
