package com.razahamid.medopd.Home;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_myAccount, R.id.nav_messages, R.id.nav_share,R.id.nav_contact,R.id.nav_rate,R.id.nav_myTest,R.id.nav_signOut)
    ...
    private void shareApplication() {
        ...
        sendIntent.putExtra(Intent.EXTRA_TEXT, "Share with friends." + " Bimari se dare nahi,  Bimari se Lade.... \n" +
                "\n" +
                "Stay safe at home over Cold cough fever , consult to a specialist MCI verified doctor online now. Download the App Now !! " + "  https://bit.ly/2D3RgGo" +  " APP");
