...
public class AllBlogpostAdapter extends RecyclerView.Adapter<AllBlogpostAdapter.ViewHolder> {
    ...
    public AllBlogpostAdapter(Context context, JSONArray jsonArray, String orientation) {
