package com.razahamid.medopddoctor.utils;
...
public class Tools {
    ...
    public static void displayImageRound(final Context ctx, final ImageView img, @DrawableRes final int drawable) {
       img.setImageDrawable(ctx.getDrawable(drawable));
    }
}
